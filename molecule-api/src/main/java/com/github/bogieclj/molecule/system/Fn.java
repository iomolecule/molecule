...
public interface Fn extends Function<Param,Param> {
     ...
     * @return The list of {@link com.github.bogieclj.molecule.system.ParamDeclaration} instances which the Fn is expected to provide as output.
     */
     ...
     * @return The list of {@link com.github.bogieclj.molecule.system.ParamDeclaration} instances which the Fn expects as input when invoked.
     */
